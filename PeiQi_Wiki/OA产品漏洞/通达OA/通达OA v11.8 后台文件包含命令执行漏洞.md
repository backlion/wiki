...
这里使用的环境为通达 v11.6版本（v11.6版本后的 Webshell 我没有绕过去，被OA过滤了，有师傅会的提供下思路感激不尽）
...
> [!NOTE]
>
> 脚本在 v11.6 测试成功执行， 在 v11.6以上执行时 webshell无法执行命令，需要找一下绕过方法
>
> 可以更改POC中的base64数据和请求位置来自定义上传点和webshell密码（webshell密码默认为 peiqi）
